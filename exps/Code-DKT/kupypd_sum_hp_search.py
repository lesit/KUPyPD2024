...
result_dir = "kupypd_result/train_hp_search" + postfix

hp_check_list = {"lr":float, "batch_size":int, "emb_size":int}
...
for semester_group in sorted(semester_group_df_dict.keys()):
    ...
    if semester_group == "kupypd_20241_group_3":
        a = 0
...
import shutil
shutil.copy2(save_path, f"semester_group_best_hp{postfix}.json")
