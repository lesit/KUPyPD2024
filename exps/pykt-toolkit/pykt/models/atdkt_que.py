...
class ATDKT(Module):
    def __init__(self, num_q, num_c, emb_size, dropout=0.1, emb_type='qid', 
            loss_pred=0.5, loss_his=0.5, l3=0.5, start=50, emb_path="", pretrain_dim=768, **kwargs):
        super().__init__()
        ...
        self.interaction_emb = QueEmb(num_q=num_q*2,num_c=num_c,emb_size=emb_size,emb_type=emb_type,device=device,
...
class ATDKTQue(QueBaseModel):
    def __init__(self, num_q,num_c, emb_size, dropout=0.1, emb_type='qid', loss_pred=0.5, loss_his=0.5, start=50, emb_path="",  pretrain_dim=768,device='cpu',seed=0, other_config={},**kwargs):
        model_name = "atdkt_que"

        super().__init__(model_name=model_name,emb_type=emb_type,emb_path=emb_path,pretrain_dim=pretrain_dim,device=device,seed=seed)
        self.model = ATDKT(num_q=num_q,num_c=num_c,emb_size=emb_size,dropout=dropout,emb_type=emb_type, loss_pred=loss_pred, loss_his=loss_his, start=start,
