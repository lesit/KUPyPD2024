...
def save_id2idx(dkeyid2idx, save_path):
    with open(save_path, "w+") as fout:
        fout.write(json.dumps(dkeyid2idx, ensure_ascii=False, indent=3))
...
def main(dname, fname, dataset_name, configf, min_seq_len = 3, maxlen = 200, kfold = 5):
    ...
    total_df, effective_keys = read_data(fname, min_seq_len)
    #cal max_concepts
    ...
    save_id2idx(dkeyid2idx, os.path.join(dname, "keyid2idx_que.json"))
